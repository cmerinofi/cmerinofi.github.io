...
Lately, I've been interested and reading many articles and new apps about new methods of diagnosis based on big models which need hughe resources. One of them was about detecting breast cancer, and they implemented the application on and AWS EC2 instance as follows.
...
Firstly, the problem was tested on an standalone  system, and after selecting the best model, the ELM, they tried the problem on cloud with different configurations.
